data[,NO:= NO/100] #change from mg-N m-2 to kg-N ha-1
data[,N2O:= N2O/100]#change from mg-N m-2 to kg-N ha-1
data[,CO2:= CO2/100]#change from g-C m-2 to Mg-C ha-1
################################################################################
# NO
...
g.1a <- (g.1a
         ...
         + geom_point(aes(colour=factor(tillage)), position=position_dodge(width=0.75), size= 0.5 )
...
#
myplot <- paste0(folder_out_kgNha, "/boxplot_NO.png")
...
g.1a <- (g.1a
         ...
         + ylab(expression('N'[2]*'O   [ kg-N ha' ^-1*' ]'))
         + xlab("Rain pattern")
         + labs(title = "(a) \n  ")
)
...
#
myplot <- paste0(folder_out_kgNha, "/boxplot_N2O.png")
png(filename=myplot,  width = 160, height = 80, units = "mm", res=1200)
...
g.1a <- (g.1a
         ...
         + ylab(expression('NO + N'[2]*'O   [ kg-N ha' ^-1*' ]'))
         + xlab("Rain pattern")
         + labs(title = "(a) \n  ")
)
...
#
myplot <- paste0(folder_out_kgNha, "/boxplot_NO.N2O.png")
png(filename=myplot,  width = 160, height = 80, units = "mm", res=1200)
...
g.1a <- (g.1a
         ...
         + ylab(expression('NO + N'[2]*'O + NH'[3]*'   [ kg-N ha' ^-1*' ]'))
         + xlab("Rain pattern")
         + labs(title = "(a) \n  ")
)
...
#
myplot <- paste0(folder_out_kgNha, "/boxplot_NO.N2O.NH3.png")
png(filename=myplot,  width = 160, height = 80, units = "mm", res=1200)
...
g.1a <- (g.1a
         ...
         + ylab(expression('NH'[3]*'   [ kg-N ha' ^-1*' ]'))
         + xlab("Rain pattern")
         + labs(title = "(a) \n  ")
)
...
#
myplot <- paste0(folder_out_kgNha, "/boxplot_NH3.png")
png(filename=myplot,  width = 160, height = 80, units = "mm", res=1200)
...
g.1a <- (g.1a
         ...
         + ylab(expression('CO'[2]*'   [ Mg-C ha' ^-1*' ]'))
         + xlab("Rain pattern")
         + labs(title = "(a) \n  ")
)
...
#
myplot <- paste0(folder_out_kgNha, "/boxplot_CO2.png")
png(filename=myplot,  width = 160, height = 80, units = "mm", res=1200)
