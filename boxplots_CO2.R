...
fit <- aov(CO2 ~ fertilizer + precipitation + tillage , data = mydata)
# fit <- Anova(aov(CO2 ~ fertilizer + precipitation*tillage, data = mydata))
summary(fit)
...
### tillage boxplot
# by treatment
myplot <- paste0(folder_out, "/CO2_boxplot_tillage_bytreatment.png")
png(filename = myplot, width = 1600, height = 1200, units = "px")

means <- aggregate(CO2 ~  tillage*precipitation*fertilizer, mydata, mean)
p <- ggplot(data=mydata, aes(x = tillage, y=CO2, fill=tillage))
...
p +
        ...
        ggtitle("Tillage effect on cumulative CO2 emission \n [g-C / m2]") +
...
myplot <- paste0(folder_out, "/CO2_boxplot_tillage.png")
png(filename = myplot, width = 320, height = 1200, units = "px")
means <- aggregate(CO2 ~  tillage, mydata, mean)
p <- ggplot(data=mydata, aes(x = tillage, y=CO2, fill=tillage))
...
# by treatment
myplot <- paste0(folder_out, "/CO2_boxplot_precipitation_bytreatment.png")
png(filename = myplot, width = 1600, height = 1200, units = "px")

means <- aggregate(CO2 ~  tillage*precipitation*fertilizer, mydata, mean)
p <- ggplot(data=mydata, aes(x = precipitation, y=CO2, fill=precipitation))
...
p +
        ...
        theme(axis.title.x = element_blank(), axis.ticks = element_blank(), axis.text.x = element_blank()) +
        theme(axis.title.y = element_blank()) +
        ggtitle("Rain-pattern effect on cumulative CO2 emission \n [g-C / m2]") +
        theme(plot.title = element_text(size = 50, lineheight=0.8, face="bold", vjust=2)) +
        theme(legend.key.height =  unit(5, "cm"))
...
# all treatments together
myplot <- paste0(folder_out, "/CO2_boxplot_precipitation.png")
png(filename = myplot, width = 320, height = 1200, units = "px")
means <- aggregate(CO2 ~  precipitation, mydata, mean)
p <- ggplot(data=mydata, aes(x = precipitation, y=CO2, fill=precipitation))
...
### fertilizer boxplot
# by treatment
myplot <- paste0(folder_out, "/CO2_boxplot_fertilizer_bytreatment.png")
png(filename = myplot, width = 1600, height = 1200, units = "px")

means <- aggregate(CO2 ~  tillage*precipitation*fertilizer, mydata, mean)
p <- ggplot(data=mydata, aes(x = fertilizer, y=CO2, fill=fertilizer))
...
p +
        ...
        theme(axis.title.x = element_blank(), axis.ticks = element_blank(), axis.text.x = element_blank()) +
        theme(axis.title.y = element_blank()) +
        ggtitle("Fertilizer-load effect on cumulative CO2 emission \n [g-C / m2]") +
        theme(plot.title = element_text(size = 50, lineheight=0.8, face="bold", vjust=2)) +
        theme(legend.key.height =  unit(5, "cm"))
...
# all treatments together
myplot <- paste0(folder_out, "/CO2_boxplot_fertilizer.png")
png(filename = myplot, width = 320, height = 1200, units = "px")
means <- aggregate(CO2 ~  fertilizer, mydata, mean)
p <- ggplot(data=mydata, aes(x = fertilizer, y=CO2, fill=fertilizer))
...
pairwise.t.test(data$CO2,data$treatment,p.adjust.method = "holm")
pairwise.t.test(data$CO2,data$labelF,p.adjust.method = "holm")
pairwise.t.test(data$CO2,data$labelT,p.adjust.method = "holm")
pairwise.t.test(data$CO2,data$labelP,p.adjust.method = "holm")

pairwise.t.test(data$CO2,data$tillage,p.adjust.method = "holm")
pairwise.t.test(data$CO2,data$precipitation,p.adjust.method = "holm")
pairwise.t.test(data$CO2,data$fertilizer,p.adjust.method = "holm")