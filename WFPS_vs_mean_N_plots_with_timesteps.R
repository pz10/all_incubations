folder_out <- paste0(output_path, "/presentation_plots/WFPS_vs_N/WFPS_vs_mean_N/time_steps")
...
rawABCDfluxes <- rbind(Aflux, Bflux, Cflux, Dflux)
################################################################################################################################################################
################################################################################################################################################################
################################################################################################################################################################
################################################################################
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days>0&days<=5,]
...
title <- paste("WFPS [%] vs NO ~ N2O relative abundance [%]", timecode_t)
myplot <- paste0(folder_out, "/slides_WFPS_vs_NOandN2O_relative_abundance", timecode, ".png")
...
state <- "full scale"
# 
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, "_", state, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS [%] vs mean NO [µg-N/m2/h] ", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, "_", state, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS [%] vs mean N2O [µg-N/m2/h] ", timecode_t)
...
state <- "full scale"
# 
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS [%] vs NO/(NO + N2O) [%]", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS [%] vs N2O/(NO + N2O) [%]", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, "_", state, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_0 [%] vs mean NO [µg-N/m2/h] ", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, "_", state, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_0 [%] vs mean N2O [µg-N/m2/h] ", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_0 [%] vs NO/(NO + N2O) [%]", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_0 [%] vs N2O/(NO + N2O) [%]", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, "_", state, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_f [%] vs mean NO [µg-N/m2/h] ", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, "_", state, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_f [%] vs mean N2O [µg-N/m2/h] ", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_f [%] vs NO/(NO + N2O) [%]", timecode_t)
...
myplot <- paste0(folder_out, "/", "slides_",  paste(i), "_",incubation, timecode, ".png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
title <- paste0(incubation, " incubations: WFPS_f [%] vs N2O/(NO + N2O) [%]", timecode_t)
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days>5&days<=10,]
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days>10&days<=15,]
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days2ndEvent>0&days2ndEvent<=5,]
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days2ndEvent>5&days2ndEvent<=10,]
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days2ndEvent>10&days2ndEvent<=15,]
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days3rdEvent>0&days3rdEvent<=5,]
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days3rdEvent>5&days3rdEvent<=10,]
...
ABCDfluxes <- copy(rawABCDfluxes)
ABCDfluxes <- ABCDfluxes[days3rdEvent>10&days3rdEvent<=15,]
