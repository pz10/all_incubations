---
title: "NH3 differences. Without transformation"
...
```{r}
fit <- lm(NH3 ~ fertilization + precipitation + tillage, data=mydata)
fit.aov <- aov(NH3 ~ fertilization + precipitation + tillage, data=mydata)
fit.aov.int <- aov(NH3 ~ (fertilization + precipitation + tillage)^2, data=mydata)

# factor removal; for later model comparison
fit1 <- lm(NH3 ~ precipitation + tillage, data=mydata)
fit2 <- lm(NH3 ~ fertilization + tillage, data=mydata)
fit3 <- lm(NH3 ~ fertilization + precipitation, data=mydata)
...
# # outlier removed
# myfit <- lm(NH3 ~ fertilization + precipitation + tillage, data=mydata[-c(68)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
```
