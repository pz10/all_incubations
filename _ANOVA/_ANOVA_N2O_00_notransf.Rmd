---
title: "N2O differences. Without transformation"
...
# # outlier removed
# myfit <- lm(N2O ~ fertilization + precipitation + tillage, data=data[-c(68)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
```
...
outlierTest(fit)
next.outlier <- lm(N2O ~ fertilization + precipitation + tillage, data=data[-c(68)]) # only 17 is an outlier
outlierTest(next.outlier)
next.outlier <- lm(N2O ~ fertilization + precipitation + tillage, data=data[-c(68,54)]) # only 17 is an outlier
outlierTest(next.outlier)
