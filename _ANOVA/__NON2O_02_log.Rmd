---
title: "NO+N2O differences. Approaches: Non-parametric and parametric (log transformation)"
...
```{r}
fit <- lm(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data)
fit.aov <- aov(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data)
fit.aov.int <- aov(log(NO.N2O) ~ (fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(log(NO.N2O) ~  precipitation + tillage, data=data)
fit2 <- lm(log(NO.N2O) ~  fertilization + tillage, data=data)
fit3 <- lm(log(NO.N2O) ~  fertilization + precipitation, data=data)

fit.int <- lm(log(NO.N2O) ~ ( fertilization + precipitation + tillage)^2, data=data)
...
```{r}
fit.p <- lmp(log(NO.N2O) ~  fertilization + precipitation + tillage, data=data)
fit.aovp <- aovp(log(NO.N2O) ~  fertilization + precipitation + tillage, data=data)
fit.aovp.int <- aovp(log(NO.N2O) ~ ( fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1.p <- lmp(log(NO.N2O) ~  precipitation + tillage, data=data)
fit2.p <- lmp(log(NO.N2O) ~  fertilization + tillage, data=data)
fit3.p <- lmp(log(NO.N2O) ~  fertilization + precipitation, data=data)

fit.int.p <- lmp(log(NO.N2O) ~ ( fertilization + precipitation + tillage)^2, data=data)
...
# 
# # outlier removed
# myfit <- lm(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
### linearity
################################################################################
# boxTidwell(log(NO.N2O) ~ fertilization + precipitation + tillage, data=data)
...
```{r}
library(leaps)
leaps <-regsubsets(log(NO.N2O) ~ ( fertilization + precipitation + tillage), data=data, nbest=4)
