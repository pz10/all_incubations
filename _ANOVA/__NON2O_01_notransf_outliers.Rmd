---
title: "NO+N2O differences. Approaches: Non-parametric and parametric (no transformation)"
...
```{r}
fit <- lm(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(68,54)])
fit.aov <- aov(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(68,54)])
fit.aov.int <- aov(NO.N2O ~ (fertilization + precipitation + tillage)^2, data=data[-c(68,54)])

# factor removal; for later model comparison
fit1 <- lm(NO.N2O ~  precipitation + tillage, data=data[-c(68,54)])
fit2 <- lm(NO.N2O ~  fertilization + tillage, data=data[-c(68,54)])
fit3 <- lm(NO.N2O ~  fertilization + precipitation, data=data[-c(68,54)])

fit.int <- lm(NO.N2O ~ ( fertilization + precipitation + tillage)^2, data=data[-c(68,54)])
...
```{r}
fit.p <- lmp(NO.N2O ~  fertilization + precipitation + tillage, data=data)
fit.aovp <- aovp(NO.N2O ~  fertilization + precipitation + tillage, data=data)
fit.aovp.int <- aovp(NO.N2O ~ ( fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1.p <- lmp(NO.N2O ~  precipitation + tillage, data=data)
fit2.p <- lmp(NO.N2O ~  fertilization + tillage, data=data)
fit3.p <- lmp(NO.N2O ~  fertilization + precipitation, data=data)

fit.int.p <- lmp(NO.N2O ~ ( fertilization + precipitation + tillage)^2, data=data)
...
# 
# # outlier removed
# myfit <- lm(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
summary(powerTransform(data[,NO.N2O]+1))
```
...
```{r}
library(leaps)
leaps <-regsubsets(NO.N2O ~ ( fertilization + precipitation + tillage), data=data[-c(68,54)], nbest=4)
...
```{r, echo=F}
# fert
results.fert <- W.MW.oneway(NO.N2O ~ fertilization, data, n=my.n)
summary(results.fert)
plot(results.fert)

# precipitation
results.rain <- W.MW.oneway(NO.N2O ~ precipitation, data, n=my.n)
summary(results.rain)
plot(results.rain)

# tillage
results.tillage <- W.MW.oneway(NO.N2O ~ tillage, data, n=my.n)
...
```{r, echo=F}
# fert
results.fert <- PToneway(NO.N2O ~ fertilization, data, n=my.n)
summary.oneway(results.fert)

# precipitation
results.rain <- PToneway(NO.N2O ~ precipitation, data, n=my.n)
summary.oneway(results.rain)

# tillage
results.till <- PToneway(NO.N2O ~ tillage, data, n=my.n)
