---
title: "NH3 (incubations A,B,C) differences. Fert=0 removed. Approaches: Non-parametric and parametric (SQRT transformation; tillage removed from model)"
...
```{r}
fit <- lm(sqrt(NH3) ~ incubation + fertilization + precipitation , data=data)
fit.aov <- aov(sqrt(NH3) ~ incubation + fertilization + precipitation , data=data)
fit.aov.int <- aov(sqrt(NH3) ~ (incubation + fertilization + precipitation )^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(sqrt(NH3) ~ incubation + precipitation , data=data)
fit2 <- lm(sqrt(NH3) ~ incubation + fertilization , data=data)
fit3 <- lm(sqrt(NH3) ~ incubation + fertilization + precipitation, data=data)

fit.int <- lm(sqrt(NH3) ~ (incubation + fertilization + precipitation )^2, data=data)
...
```{r}
library(leaps)
leaps <-regsubsets(sqrt(NH3) ~ (incubation + fertilization + precipitation ), data=data, nbest=4)
