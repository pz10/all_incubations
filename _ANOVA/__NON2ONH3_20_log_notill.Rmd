---
title: "NO + N2O +NH3 (incubations A,B,C) differences. Approaches: Non-parametric and parametric (log transformation; tillage remove from model)"
...
```{r}
fit <- lm(log(NO.N2O.NH3) ~ incubation + fertilization + precipitation, data=data)
fit.aov <- aov(log(NO.N2O.NH3) ~ incubation + fertilization + precipitation, data=data)
fit.aov.int <- aov(log(NO.N2O.NH3) ~ (incubation + fertilization + precipitation)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(log(NO.N2O.NH3) ~ incubation + precipitation, data=data)
fit2 <- lm(log(NO.N2O.NH3) ~ incubation + fertilization, data=data)
fit3 <- lm(log(NO.N2O.NH3) ~ incubation + fertilization + precipitation, data=data)

fit.int <- lm(log(NO.N2O.NH3) ~ (incubation + fertilization + precipitation)^2, data=data)
...
```{r}
fit.p <- lmp(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)
fit.aovp <- aovp(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)
fit.aovp.int <- aovp(NO.N2O.NH3 ~ (incubation + fertilization + precipitation)^2, data=data)

# factor removal; for later model comparison
fit1.p <- lmp(NO.N2O.NH3 ~ incubation + precipitation, data=data)
fit2.p <- lmp(NO.N2O.NH3 ~ incubation + fertilization, data=data)
fit3.p <- lmp(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)

fit.int.p <- lmp(NO.N2O.NH3 ~ (incubation + fertilization + precipitation)^2, data=data)
...
# 
# # outlier removed
# myfit <- lm(NO.N2O.NH3 ~ fertilization + precipitation, data=data[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation, data=data[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation, data=data[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation, data=data[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation, data=data[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
### linearity
################################################################################
# boxTidwell(NO.N2O.NH3 ~ fertilization + precipitation, data=data)
...
```{r}
library(leaps)
leaps <-regsubsets(log(NO.N2O.NH3) ~ (incubation + fertilization + precipitation), data=data, nbest=4)
