---
title: "NO + N2O +NH3 (incubations A,B,C) differences. Approaches: Non-parametric and parametric (no transformation; no tillage)"
...
```{r}
fit <- lm(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)
fit.aov <- aov(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)
fit.aov.int <- aov(NO.N2O.NH3 ~ (incubation + fertilization + precipitation)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(NO.N2O.NH3 ~ incubation + precipitation, data=data)
fit2 <- lm(NO.N2O.NH3 ~ incubation + fertilization, data=data)
fit3 <- lm(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)

fit.int <- lm(NO.N2O.NH3 ~ (incubation + fertilization + precipitation)^2, data=data)
...
```{r}
library(leaps)
leaps <-regsubsets(NO.N2O.NH3 ~ (incubation + fertilization + precipitation), data=data, nbest=4)
