---
title: "NH3 (incubations A,B,C) differences. Fert=0 removed. Approaches: Non-parametric and parametric (no transformation)"
...
```{r}
fit <- lm(NH3 ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov <- aov(NH3 ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov.int <- aov(NH3 ~ (incubation + fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(NH3 ~ incubation + precipitation + tillage, data=data)
fit2 <- lm(NH3 ~ incubation + fertilization + tillage, data=data)
fit3 <- lm(NH3 ~ incubation + fertilization + precipitation, data=data)

fit.int <- lm(NH3 ~ (incubation + fertilization + precipitation + tillage)^2, data=data)
...
summary(powerTransform(data[,NH3]+1))
```
...
```{r}
library(leaps)
leaps <-regsubsets(NH3 ~ (incubation + fertilization + precipitation + tillage), data=data, nbest=4)
