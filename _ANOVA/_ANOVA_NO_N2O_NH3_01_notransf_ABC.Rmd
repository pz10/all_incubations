...
```{r}
fit <- lm(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data.ABC)
fit.aov <- aov(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data.ABC)
fit.aov.int <- aov(NO.N2O.NH3 ~ (fertilization + precipitation + tillage)^2, data=data.ABC)

# factor removal; for later model comparison
fit1 <- lm(NO.N2O.NH3 ~ precipitation + tillage, data=data.ABC)
fit2 <- lm(NO.N2O.NH3 ~ fertilization + tillage, data=data.ABC)
fit3 <- lm(NO.N2O.NH3 ~ fertilization + precipitation, data=data.ABC)
...
# visualization
                # library(HH)
interaction2wt(NO.N2O.NH3 ~ (fertilization + precipitation + tillage)^2, data=data.ABC, main=paste("main effect and 2-way interactions \n",fit.aov.int$cal[2]))
```
...
# # outlier removed
# myfit <- lm(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data.ABC[-c(68)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
...
### linearity
################################################################################
# boxTidwell(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data.ABC)
...
```{r}
library(leaps)
leaps <-regsubsets(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data.ABC, nbest=4)
