...
```{r}
fit <- lm(NO.N2O.NH3 ~ fertilization + precipitation , data=data.ABC)
fit.aov <- aov(NO.N2O.NH3 ~ fertilization + precipitation , data=data.ABC)
fit.aov.int <- aov(NO.N2O.NH3 ~ (fertilization + precipitation )^2, data=data.ABC)
