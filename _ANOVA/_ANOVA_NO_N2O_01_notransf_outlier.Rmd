---
title: "NO+N2O differences. Without transformation. Two outlier removed"
...
# visualization
                # library(HH)
interaction2wt(NO.N2O ~ (fertilization + precipitation + tillage)^2, data=data[-c(68,54)], main=paste("main effect and 2-way interactions \n",fit.aov.int$cal[2]))
```
...
outlierTest(fit)
# next.outlier <- lm(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(54)])
# outlierTest(next.outlier)
# # next.outlier <- lm(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(68,54)])
# # outlierTest(next.outlier)
# 
# 
# # identify outliers
...
### linearity
################################################################################
# boxTidwell(NO.N2O ~ fertilization + precipitation + tillage, data=data[-c(68,54)])
