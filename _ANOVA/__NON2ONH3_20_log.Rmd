---
title: "NO + N2O +NH3 (incubations A,B,C) differences. Approaches: Non-parametric and parametric (log transformation)"
output: html_document
---

priming obtained as follows: mean(2nd + 3rd) / (1st)

```{r, echo=F}
data <- data[incubation!="D"]
data[,incubation:= factor(incubation)]

data[,.(
        mean.NO.N2O.NH3 = mean(NO.N2O.NH3, na.rm=T),
        sd.NO.N2O.NH3 = sd(NO.N2O.NH3, na.rm=T),
        se.NO.N2O.NH3 = sd(NO.N2O.NH3, na.rm=T)/log(sum(!is.na(NO.N2O.NH3))),
...
par(mfrow=c(1,4))
with(data, boxplot(NO.N2O.NH3 ~ fertilization, main = "fertilization"))
with(data, boxplot(NO.N2O.NH3 ~ precipitation, main = "precipitation"))
with(data, boxplot(NO.N2O.NH3 ~ tillage, main = "tillage"))
with(data, boxplot(NO.N2O.NH3 ~ incubation, main = "incubation"))


par(mfrow=c(1,4))
ggplot(data=data, aes(x=fertilization, y=NO.N2O.NH3)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()
ggplot(data=data, aes(x=precipitation, y=NO.N2O.NH3)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()
ggplot(data=data, aes(x=tillage, y=NO.N2O.NH3)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()
ggplot(data=data, aes(x=incubation, y=NO.N2O.NH3)) + 
        geom_point(size=3, color="darkgrey", alpha=0.5) +
        theme_bw()

```
![NO.N2O.NH3 fluxes](auxiliary_plots_for_ANOVA_reports/ABC_boxplot_NO.N2O.NH3.png)
...
```{r}
fit <- lm(log(NO.N2O.NH3) ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov <- aov(log(NO.N2O.NH3) ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov.int <- aov(log(NO.N2O.NH3) ~ (incubation + fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(log(NO.N2O.NH3) ~ incubation + precipitation + tillage, data=data)
fit2 <- lm(log(NO.N2O.NH3) ~ incubation + fertilization + tillage, data=data)
fit3 <- lm(log(NO.N2O.NH3) ~ incubation + fertilization + precipitation, data=data)

fit.int <- lm(log(NO.N2O.NH3) ~ (incubation + fertilization + precipitation + tillage)^2, data=data)
...
```{r}
fit.p <- lmp(NO.N2O.NH3 ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aovp <- aovp(NO.N2O.NH3 ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aovp.int <- aovp(NO.N2O.NH3 ~ (incubation + fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1.p <- lmp(NO.N2O.NH3 ~ incubation + precipitation + tillage, data=data)
fit2.p <- lmp(NO.N2O.NH3 ~ incubation + fertilization + tillage, data=data)
fit3.p <- lmp(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)

fit.int.p <- lmp(NO.N2O.NH3 ~ (incubation + fertilization + precipitation + tillage)^2, data=data)
...
# 
# # outlier removed
# myfit <- lm(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
# myoutliers <- c(68,54)
# data[myoutliers, .(id, NO.N2O.NH3, CO2.1.3, NO.N2O.NH3, CO2.1.3)]
# 
...
summary(powerTransform(data[,log(NO.N2O.NH3)]))
```
...
### linearity
################################################################################
# boxTidwell(NO.N2O.NH3 ~ fertilization + precipitation + tillage, data=data)
...
```{r}
library(leaps)
leaps <-regsubsets(log(NO.N2O.NH3) ~ (incubation + fertilization + precipitation + tillage), data=data, nbest=4)
...
```{r, echo=F}
# fert
results.fert <- W.MW.oneway(NO.N2O.NH3 ~ fertilization, data, n=my.n)
summary(results.fert)
plot(results.fert)

# precipitation
results.rain <- W.MW.oneway(NO.N2O.NH3 ~ precipitation, data, n=my.n)
summary(results.rain)
plot(results.rain)

# tillage
results.tillage <- W.MW.oneway(NO.N2O.NH3 ~ tillage, data, n=my.n)
...
```{r, echo=F}
# fert
results.fert <- PToneway(NO.N2O.NH3 ~ fertilization, data, n=my.n)
summary.oneway(results.fert)

# precipitation
results.rain <- PToneway(NO.N2O.NH3 ~ precipitation, data, n=my.n)
summary.oneway(results.rain)

# tillage
results.till <- PToneway(NO.N2O.NH3 ~ tillage, data, n=my.n)
