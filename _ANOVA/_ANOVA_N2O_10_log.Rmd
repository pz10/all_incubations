---
title: "N2O differences. log(N2O) transformation"
...
# outlier removed
# myfit <- lm(log(N2O) ~ fertilization + precipitation + tillage, data=data[-c(44)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
```
...
outlierTest(fit)
next.outlier <- lm(log(N2O) ~ fertilization + precipitation + tillage, data=data[-c(44)])
outlierTest(next.outlier)
next.outlier <- lm(log(N2O) ~ fertilization + precipitation + tillage, data=data[-c(44,49+1)])
