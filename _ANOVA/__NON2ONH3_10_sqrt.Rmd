---
title: "NO + N2O +NH3 (incubations A,B,C) differences. Approaches: Non-parametric and parametric (SQRT transformation)"
...
```{r}
fit <- lm(sqrt(NO.N2O.NH3) ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov <- aov(sqrt(NO.N2O.NH3) ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov.int <- aov(sqrt(NO.N2O.NH3) ~ (incubation + fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(sqrt(NO.N2O.NH3) ~ incubation + precipitation + tillage, data=data)
fit2 <- lm(sqrt(NO.N2O.NH3) ~ incubation + fertilization + tillage, data=data)
fit3 <- lm(sqrt(NO.N2O.NH3) ~ incubation + fertilization + precipitation, data=data)

fit.int <- lm(sqrt(NO.N2O.NH3) ~ (incubation + fertilization + precipitation + tillage)^2, data=data)
...
summary(powerTransform(data[,sqrt(NO.N2O.NH3)]))
```
...
```{r}
library(leaps)
leaps <-regsubsets(sqrt(NO.N2O.NH3) ~ (incubation + fertilization + precipitation + tillage), data=data, nbest=4)
