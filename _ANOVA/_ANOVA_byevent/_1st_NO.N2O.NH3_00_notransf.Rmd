---
title: "1st stretch NO+N2O+NH3 differences. Approaches: Non-parametric and parametric (no transformation)"
...
# fit <- lm(NO.N2O.NH3 ~ fertilization + precipitation + tillage + fertilization:precipitation + fertilization:tillage, data=mydata)
