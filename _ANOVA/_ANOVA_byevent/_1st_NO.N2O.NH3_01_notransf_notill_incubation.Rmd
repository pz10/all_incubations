---
title: "1st stretch NO+N2O+NH3 differences. Approaches: Non-parametric and parametric (no transformation; remove tillage and include incubation in the model)"
...
```{r}
fit <- lm(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata)
fit.aov <- aov(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata)
fit.aov.int <- aov(NO.N2O.NH3 ~ (fertilization + precipitation + incubation)^2, data=mydata)

# factor removal; for later model comparison
fit1 <- lm(NO.N2O.NH3 ~  precipitation + incubation, data=mydata)
fit2 <- lm(NO.N2O.NH3 ~  fertilization + incubation, data=mydata)
fit3 <- lm(NO.N2O.NH3 ~  fertilization + precipitation, data=mydata)

fit.int <- lm(NO.N2O.NH3 ~ ( fertilization + precipitation + incubation)^2, data=mydata)

fit <- lm(NO.N2O.NH3 ~ fertilization + precipitation + incubation + fertilization:precipitation + fertilization:tillage, data=mydata)
fit.aov <- fit.aov <- aov(NO.N2O.NH3 ~ fertilization + precipitation + incubation + fertilization:precipitation + fertilization:tillage, data=mydata)
...
```{r}
fit.p <- lmp(NO.N2O.NH3 ~  fertilization + precipitation + incubation, data=mydata)
fit.aovp <- aovp(NO.N2O.NH3 ~  fertilization + precipitation + incubation, data=mydata)
fit.aovp.int <- aovp(NO.N2O.NH3 ~ ( fertilization + precipitation + incubation)^2, data=mydata)

# factor removal; for later model comparison
fit1.p <- lmp(NO.N2O.NH3 ~  precipitation + incubation, data=mydata)
fit2.p <- lmp(NO.N2O.NH3 ~  fertilization + incubation, data=mydata)
fit3.p <- lmp(NO.N2O.NH3 ~  fertilization + precipitation, data=mydata)

fit.int.p <- lmp(NO.N2O.NH3 ~ ( fertilization + precipitation + incubation)^2, data=mydata)
...
# 
# # outlier removed
# myfit <- lm(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
summary(powerTransform(mydata[,NO.N2O.NH3]+1))
```
...
### linearity
################################################################################
# boxTidwell(NO.N2O.NH3 ~ fertilization + precipitation + incubation, data=mydata)
...
```{r}
library(leaps)
leaps <-regsubsets(NO.N2O.NH3 ~ ( fertilization + precipitation + incubation), data=mydata, nbest=4)
