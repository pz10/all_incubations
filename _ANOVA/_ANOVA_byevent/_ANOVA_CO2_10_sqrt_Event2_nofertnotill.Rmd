---
title: "CO2 differences (2nd event). Sqrt transformation. no fert no till"
...
```{r}
fit <- lm(sqrt(CO2) ~ precipitation, data=data)
fit.aov <- aov(sqrt(CO2) ~ precipitation, data=data)
