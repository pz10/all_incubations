---
title: "1st stretch NO+N2O+NH3 differences. Approaches: Non-parametric and parametric (sqrt transformation; remove tillage and include incubation in the model)"
...
par(mfrow=c(1,4))
with(mydata, boxplot(sqrt(NO.N2O.NH3) ~ fertilization, main = "fertilization"))
with(mydata, boxplot(sqrt(NO.N2O.NH3) ~ precipitation, main = "precipitation"))
with(mydata, boxplot(sqrt(NO.N2O.NH3) ~ tillage, main = "tillage"))
with(mydata, boxplot(sqrt(NO.N2O.NH3) ~ incubation, main = "incubation"))
...
```{r, echo=F}
# replace strings:
# 1. "sqrt(NO.N2O.NH3) ~" --> "transformation ~"
# 2. "[,sqrt(NO.N2O.NH3)]" --> "[,transformation]"
```

```{r}
fit <- lm(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata)
fit.aov <- aov(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata)
fit.aov.int <- aov(sqrt(NO.N2O.NH3) ~ (fertilization + precipitation + incubation)^2, data=mydata)

# factor removal; for later model comparison
fit1 <- lm(sqrt(NO.N2O.NH3) ~  precipitation + incubation, data=mydata)
fit2 <- lm(sqrt(NO.N2O.NH3) ~  fertilization + incubation, data=mydata)
fit3 <- lm(sqrt(NO.N2O.NH3) ~  fertilization + precipitation, data=mydata)

fit.int <- lm(sqrt(NO.N2O.NH3) ~ ( fertilization + precipitation + incubation)^2, data=mydata)

fit <- lm(sqrt(NO.N2O.NH3) ~ ( incubation + fertilization + precipitation)^2, data=mydata)
fit.aov <- aov(sqrt(NO.N2O.NH3) ~ (incubation + fertilization + precipitation)^2, data=mydata)
...
```{r}
fit.p <- lmp(sqrt(NO.N2O.NH3) ~  fertilization + precipitation + incubation, data=mydata)
fit.aovp <- aovp(sqrt(NO.N2O.NH3) ~  fertilization + precipitation + incubation, data=mydata)
fit.aovp.int <- aovp(sqrt(NO.N2O.NH3) ~ ( fertilization + precipitation + incubation)^2, data=mydata)

# factor removal; for later model comparison
fit1.p <- lmp(sqrt(NO.N2O.NH3) ~  precipitation + incubation, data=mydata)
fit2.p <- lmp(sqrt(NO.N2O.NH3) ~  fertilization + incubation, data=mydata)
fit3.p <- lmp(sqrt(NO.N2O.NH3) ~  fertilization + precipitation, data=mydata)

fit.int.p <- lmp(sqrt(NO.N2O.NH3) ~ ( fertilization + precipitation + incubation)^2, data=mydata)
...
# 
# INDEPENDENCE OF ERRORS (autocorrelation) 
# independence (it might be of interest to check whether ther is any autocorrelation regarding chronosqrtical sampling order whitin one incubation)
...
# 
# # outlier removed
# myfit <- lm(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
summary(powerTransform(mydata[,sqrt(NO.N2O.NH3)]+1))
```
...
### linearity
################################################################################
# boxTidwell(sqrt(NO.N2O.NH3) ~ fertilization + precipitation + incubation, data=mydata)
...
```{r}
library(leaps)
leaps <-regsubsets(sqrt(NO.N2O.NH3) ~ ( fertilization + precipitation + incubation), data=mydata, nbest=4)
...
```{r, echo=F}
# fert
# results.fert <- W.MW.oneway(sqrt(NO.N2O.NH3) ~ fertilization, mydata, n=my.n)
# summary(results.fert)
# # plot(results.fert)
# 
# # precipitation
# results.rain <- W.MW.oneway(sqrt(NO.N2O.NH3) ~ precipitation, mydata, n=my.n)
# summary(results.rain)
# # plot(results.rain)
# 
# # # tillage
# # results.tillage <- W.MW.oneway(sqrt(NO.N2O.NH3) ~ tillage, mydata, n=my.n)
...
```{r, echo=F}
# # fert
# results.fert <- PToneway(sqrt(NO.N2O.NH3) ~ fertilization, mydata, n=my.n)
# summary.oneway(results.fert)
# 
# # precipitation
# results.rain <- PToneway(sqrt(NO.N2O.NH3) ~ precipitation, mydata, n=my.n)
# summary.oneway(results.rain)
# 
# # # tillage
# # results.till <- PToneway(sqrt(NO.N2O.NH3) ~ tillage, mydata, n=my.n)
