---
title: "1st stretch NO+N2O differences. Approaches: Non-parametric and parametric (log transformation; tillage removed from model)"
...
```{r}
fit <- lm(log(NO.N2O) ~ fertilization + precipitation , data=mydata)
fit.aov <- aov(log(NO.N2O) ~ fertilization + precipitation , data=mydata)
fit.aov.int <- aov(log(NO.N2O) ~ (fertilization + precipitation )^2, data=mydata)

# factor removal; for later model comparison
fit1 <- lm(log(NO.N2O) ~  precipitation , data=mydata)
fit2 <- lm(log(NO.N2O) ~  fertilization , data=mydata)
fit3 <- lm(log(NO.N2O) ~  fertilization + precipitation, data=mydata)

fit.int <- lm(log(NO.N2O) ~ ( fertilization + precipitation )^2, data=mydata)

# fit <- lm(log(NO.N2O) ~ fertilization + precipitation  + fertilization:precipitation + fertilization:tillage, data=mydata)
# fit.aov <- fit.aov <- aov(log(NO.N2O) ~ fertilization + precipitation  + fertilization:precipitation + fertilization:tillage, data=mydata)
...
```{r}
fit.p <- lmp(log(NO.N2O) ~  fertilization + precipitation , data=mydata)
fit.aovp <- aovp(log(NO.N2O) ~  fertilization + precipitation , data=mydata)
fit.aovp.int <- aovp(log(NO.N2O) ~ ( fertilization + precipitation )^2, data=mydata)

# factor removal; for later model comparison
fit1.p <- lmp(log(NO.N2O) ~  precipitation , data=mydata)
fit2.p <- lmp(log(NO.N2O) ~  fertilization , data=mydata)
fit3.p <- lmp(log(NO.N2O) ~  fertilization + precipitation, data=mydata)

fit.int.p <- lmp(log(NO.N2O) ~ ( fertilization + precipitation )^2, data=mydata)
...
# 
# # outlier removed
# myfit <- lm(log(NO.N2O) ~ fertilization + precipitation , data=mydata[-c(6, 48,66)])
# gvmodel <- gvlma(myfit)
# summary(gvmodel)
# ```
...
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation , data=mydata[-c(66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation , data=mydata[-c(48,66)]) 
# outlierTest(next.outlier)
# 
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation , data=mydata[-c(6, 48,66)]) 
# outlierTest(next.outlier)
# next.outlier <- lmp(log(NO.N2O) ~ fertilization + precipitation , data=mydata[-c(68,54)]) # only 17 is an outlier
# outlierTest(next.outlier)
# 
# 
# # identify outliers
...
### linearity
################################################################################
# boxTidwell(log(NO.N2O) ~ fertilization + precipitation , data=mydata)
...
```{r}
library(leaps)
leaps <-regsubsets(log(NO.N2O) ~ ( fertilization + precipitation ), data=mydata, nbest=4)
