---
title: "3rd stretch NO+N2O differences. Approaches: Non-parametric and parametric (no transformation)"
...
# fit <- lm(NO.N2O ~ fertilization + precipitation + tillage + fertilization:tillage, data=mydata)
# fit.aov <- fit.aov <- aov(NO.N2O ~ fertilization + precipitation + tillage + fertilization:tillage, data=mydata)
...
summary(powerTransform(mydata[,NO.N2O]))
```
