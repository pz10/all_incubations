---
title: "CO2 differences (3rd event). Without transformation"
...
```{r}
fit <- lm(CO2 ~ fertilization + precipitation + tillage, data=data)
fit.aov <- aov(CO2 ~ fertilization + precipitation + tillage, data=data)
fit.aov.int <- aov(CO2 ~ (fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(CO2 ~ precipitation + tillage, data=data)
fit2 <- lm(CO2 ~ fertilization + tillage, data=data)
fit3 <- lm(CO2 ~ fertilization + precipitation, data=data)
...
# visualization
                # library(HH)
interaction2wt(CO2 ~ (fertilization + precipitation + tillage)^2, data=data, main=paste("main effect and 2-way interactions \n",fit.aov.int$cal[2]))
```
