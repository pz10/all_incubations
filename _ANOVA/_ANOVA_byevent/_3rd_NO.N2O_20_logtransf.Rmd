---
title: "3rd stretch NO+N2O differences. Approaches: Non-parametric and parametric (log transformation)"
...
summary(powerTransform(mydata[,log(NO.N2O)]+2))
```
