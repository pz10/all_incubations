---
title: "NO + N2O +NH3 (incubations A,B,C) differences. Approaches: Non-parametric and parametric (no transformation)"
...
```{r}
fit <- lm(NO.N2O.NH3 ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov <- aov(NO.N2O.NH3 ~ incubation + fertilization + precipitation + tillage, data=data)
fit.aov.int <- aov(NO.N2O.NH3 ~ (incubation + fertilization + precipitation + tillage)^2, data=data)

# factor removal; for later model comparison
fit1 <- lm(NO.N2O.NH3 ~ incubation + precipitation + tillage, data=data)
fit2 <- lm(NO.N2O.NH3 ~ incubation + fertilization + tillage, data=data)
fit3 <- lm(NO.N2O.NH3 ~ incubation + fertilization + precipitation, data=data)

fit.int <- lm(NO.N2O.NH3 ~ (incubation + fertilization + precipitation + tillage)^2, data=data)
...
summary(powerTransform(data[,NO.N2O.NH3]))
```
...
```{r}
library(leaps)
leaps <-regsubsets(NO.N2O.NH3 ~ (incubation + fertilization + precipitation + tillage), data=data, nbest=4)
