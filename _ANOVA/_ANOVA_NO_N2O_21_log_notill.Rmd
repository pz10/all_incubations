...
same conclusions as that found with tillage inside the OLS model
</span>
...
# visualization
                # library(HH)
interaction2wt(log(NO.N2O) ~ (fertilization + precipitation )^2, data=data, main=paste("main effect and 2-way interactions \n",fit.aov.int$cal[2]))
```
